...
AuditAction = Literal[
    ...
    "whatsapp_configuration.created",
    "whatsapp_configuration.updated",
    "whatsapp_configuration.activated",
    "whatsapp_configuration.deactivated",
    "whatsapp_configuration.deleted",
    "whatsapp_configuration.credentials_rotated",
    "business_configuration.created",
    "business_configuration.updated",
    "knowledge.created",
    "knowledge.updated",
    "knowledge.published",
    "knowledge.archived",
